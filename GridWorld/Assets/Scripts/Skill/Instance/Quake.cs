...
public class Quake : Skill{
	...
	public override SkillAnimation GetAnimation(int x, int y, int direction, float length){
		return new QuakeAnimation(x, y, direction, length);
	}
	
	public class QuakeAnimation : BoxSkillAnimation{
		
		public QuakeAnimation(int x, int y, int direction, float length) : base(x, y, direction, length){
