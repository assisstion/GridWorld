...
public class FrostBlast : Skill{
	...
	public override SkillAnimation GetAnimation(int x, int y, int direction, float length){
		return new FrostBlastAnimation(x, y, direction, length);
	}

	public class FrostBlastAnimation : BoxSkillAnimation{
		
		public FrostBlastAnimation(int x, int y, int direction, float length) : base(x, y, direction, length){
